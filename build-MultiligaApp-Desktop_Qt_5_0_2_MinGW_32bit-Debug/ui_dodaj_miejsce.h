/********************************************************************************
** Form generated from reading UI file 'dodaj_miejsce.ui'
**
...
#ifndef UI_DODAJ_MIEJSCE_H
#define UI_DODAJ_MIEJSCE_H
...
public:
    ...
    {
        if (dodaj_miejsce->objectName().isEmpty())
            dodaj_miejsce->setObjectName(QStringLiteral("dodaj_miejsce"));
        dodaj_miejsce->resize(613, 487);
        label_3 = new QLabel(dodaj_miejsce);
        label_3->setObjectName(QStringLiteral("label_3"));
        label_3->setGeometry(QRect(180, 10, 251, 20));
        layoutWidget = new QWidget(dodaj_miejsce);
        layoutWidget->setObjectName(QStringLiteral("layoutWidget"));
        layoutWidget->setGeometry(QRect(20, 40, 571, 431));
        ...
        layoutWidget_2->setGeometry(QRect(20, 40, 231, 102));
        ...
        layoutWidget_3->setGeometry(QRect(20, 40, 231, 71));
        ...
        QMetaObject::connectSlotsByName(dodaj_miejsce);
    } // setupUi

    void retranslateUi(QDialog *dodaj_miejsce)
    {
        dodaj_miejsce->setWindowTitle(QApplication::translate("dodaj_miejsce", "Dialog", 0));
        label_3->setText(QString());
        groupBox->setTitle(QApplication::translate("dodaj_miejsce", "Miejsce rozgrywek", 0));
        label_2->setText(QApplication::translate("dodaj_miejsce", "Nazwa", 0));
...
namespace Ui {
    class dodaj_miejsce: public Ui_dodaj_miejsce {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_DODAJ_MIEJSCE_H
